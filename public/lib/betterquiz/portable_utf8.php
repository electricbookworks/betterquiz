<?php
    ...
    */
    ...
    /**
     * utf8_isspace ( )
     * Returns true if the given char is a WhiteSpace char in utf8
     * @since CMJ
     *
     * @return boolean True if the given char is whitespace.
     */
    function utf8_isspace($c) {
        foreach (utf8_ws() as $k=>$w) {
            if ($c==$w) return true;
        }
        return false;
    }
